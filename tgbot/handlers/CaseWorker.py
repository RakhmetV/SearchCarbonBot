...
from tgbot.keyboards.inline import researchesStart, carbon_footprint, carbonFootprintTest, carbonFootprintAnswer, \
    inline_interaction_three, carbon_heard, carbon_greenhouse_effect
...
async def carbon_Heard(call: CallbackQuery):
    await call.message.answer('Так как большая часть парникового газа состоит из СО2 (80 %), то след называют углеродным')
    await asyncio.sleep(1)
