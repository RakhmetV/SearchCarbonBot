...
async def interact_case_seven(call: CallbackQuery):
    await call.answer(cache_time=5)
...
async def interact_case_eight(call: CallbackQuery):
    await call.answer(cache_time=5)
...
def register_interaction_case(dp: Dispatcher):
    ...
    dp.register_callback_query_handler(interact_case_seven, text_contains='inlineInteractSix', state=None)
    dp.register_callback_query_handler(interact_case_eight, text_contains='inlineInteractSeven', state=None)
    dp.register_callback_query_handler(interact_case_nine, text_contains='inlineInteractEight ', state=None)
